...
contract SliceofMeta is Context, IERC20, Ownable {
    ...
    string private _name = "SliceofMeta";
    ...
    address public charityWallet = 0xd30b75aF6b457bB4939Dc506bD5D857D2931d00e;
    ...
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**7;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'Pancake');
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     //to recieve ETH from uniswapV2Router when swaping&BNBPCS
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            9, // slippage is unavoidable b+
            9, // slippage is unavoidable s-
            owner(),
            block.timestamp
        );
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        // if SOM can be listed on exchanges (CEX), we will remove fees. 
        _taxFee = 0;
        _liquidityFee = 0;
